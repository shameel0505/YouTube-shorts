...
{{
  ...
  "description": "Write a highly professional, concise, and engaging social media caption that accurately summarizes the core topic of the video. Use a maximum of 1-2 relevant emojis. Do NOT over-use emojis. End with a strong Call to Action (CTA) question.",
...
{{
  ...
  "description": "Write a highly professional, concise, and engaging YouTube description that accurately summarizes the video. Use a maximum of 1-2 relevant emojis. Do NOT over-use emojis. End with a strong Call to Action (CTA) question.",
